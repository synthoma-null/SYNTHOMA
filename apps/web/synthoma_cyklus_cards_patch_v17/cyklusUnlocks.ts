...
export const CYKLUS_UNLOCKS: CardUnlock[] = [
  ...
  // ── Patch v12: redundantní bezpečné cesty k poolům ─────────────────────────
  // Pool může být odemčen nejen jedním flagem, ale i itemem/imprintem, který má
  // stejný diegetický význam. Ano, i odemykání potřebuje záložní plán. Lidstvo se
  // zjevně poučilo z tlačítek „Uložit“ a „Uložit jako“.
  {
    id: 'form_office_pool_unlock_by_blank_form',
    poolId: 'form_office_pool',
    condition: { type: 'hasItem', itemId: 'blank_form' },
  },
  {
    id: 'relationship_followups_unlock_by_imprint',
    poolId: 'relationship_followups',
    condition: { type: 'hasImprint', imprintId: 'unfinished_conversation' },
  },
  {
    id: 'sarkasma_debt_pool_unlock_by_imprint',
    poolId: 'sarkasma_debt_pool',
    condition: { type: 'hasImprint', imprintId: 'sarkasma_debt' },
  },
  {
    id: 'archive_scent_pool_unlock_by_imprint',
    poolId: 'archive_scent_pool',
    condition: { type: 'hasImprint', imprintId: 'archive_scent' },
  },
  {
    id: 'memory_sandbox_pool_unlock_by_spade',
    poolId: 'memory_sandbox_pool',
    condition: { type: 'hasItem', itemId: 'childhood_spade' },
  },
  {
    id: 'token_market_pool_unlock_by_named_token',
    poolId: 'token_market_pool',
    condition: { type: 'hasItem', itemId: 'named_token' },
  },
  {
    id: 'market_pool_unlock_by_coin',
    poolId: 'market_pool',
    condition: { type: 'hasItem', itemId: 'market_coin' },
  },
  {
    id: 'soft_bug_pool_unlock_by_named_bug',
    poolId: 'soft_bug_pool',
    condition: { type: 'hasItem', itemId: 'named_soft_bug' },
  },
  {
    id: 'wrong_name_pool_unlock_by_sector_card',
    poolId: 'wrong_name_pool',
    condition: { type: 'usedCard', cardId: 'sector_wrong_name' },
  },
  {
    id: 'market_sells_no_pool_unlock_by_flag',
    poolId: 'market_sells_no_pool',
    condition: { type: 'hasAnyFlag', flags: ['market_receipt_hidden', 'token_abandoned'] },
  },
  {
    id: 'memory_beast_pool_unlock_by_seen_entity',
    poolId: 'memory_beast_pool',
    condition: { type: 'usedCard', cardId: 'entity_memory_beast' },
  },
];
