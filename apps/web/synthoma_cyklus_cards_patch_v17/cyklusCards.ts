...
<p class="dialogS">„Tak. Dohráli jsme fázi, kdy ses tvářil, že dluh je metafora. Teď ho pojmenuješ, nebo ho pojmenuje systém. A věř mi, systém má vkus nemocničního automatu na kávu.“</p>`,
  ...
  tutorial_01_swipe: {
    ...
    sceneHtml: `<p class="log fx-scanline"><span class="datastream">LOG [TUTORIAL/SWIPE]:</span> karta není dotazník. Karta je malá nehoda s možností výběru směru.</p><p class="text">Každá karta je scéna. Některé jsou dveře. Některé past. Některé jen velmi sebevědomý předmět, který se rozhodl změnit tvůj den.</p><p class="text"><span class="fx-outline is-lit">ANO</span> obvykle znamená vstoupit, přijmout, riskovat. <span class="fx-outline hollow">NE</span> obvykle znamená odmítnout, odložit, kontrolovat. Obvykle. Systém má smysl pro humor a žádné svědomí.</p><p class="dialogS">„Kdyby byly volby jasné, lidstvo by nemělo historii. Jen údržbový manuál.“</p>`,
  ...
  tutorial_02_stats: {
    ...
    sceneHtml: `<p class="log fx-scanline"><span class="datastream">LOG [TUTORIAL/STATS]:</span> čtyři stabilizační osy načteny. Čtyři způsoby, jak si elegantně zavařit.</p><p class="text"><span class="fx-neon">Energie</span> je výkon a přepálení. <span class="fx-neon">Paměť</span> je kontinuita a povodeň. <span class="fx-neon">Vazba</span> je spojení a rozpuštění. <span class="fx-neon">Kontrola</span> je tvar a klec.</p><p class="text">Drž je při životě. Ne vysoko. Ne nízko. Živě. Což je pro systém nepříjemné, protože živé věci odmítají zůstat v tabulkách.</p><p class="dialogS">„Čtyři ukazatele. Čtyři příležitosti předstírat, že máš plán.“</p>`,
  ...
  tutorial_03_balance: {
    ...
    sceneHtml: `<p class="log fx-scanline"><span class="datastream">LOG [TUTORIAL/BALANCE]:</span> bezpečné pásmo 20–80 aktivní. Extrémy doporučeny pouze subjektům se zálibou v dramatických koncích.</p><p class="text">T-AI zvýrazní středové pásmo. Nezáří hrdinsky. Spíš prakticky. Jako zábradlí na schodišti, kterému nikdo neděkuje, dokud se nepokusí padat.</p><p class="text">Maximum není výhra. Minimum není klid. Oba okraje jsou jen různé způsoby, jak dát systému důvod napsat o tobě studii.</p><p class="dialogS">„Střed není zbabělost. Je to jen méně sexy než kolaps. Což je přesně důvod, proč ho lidi ignorují.“</p>`,
  ...
  tutorial_04_preview: {
    ...
    sceneHtml: `<p class="log fx-scanline"><span class="datastream">LOG [TUTORIAL/PREVIEW]:</span> predikční vrstva zapnuta. Přesnost: užitečná, nikoliv božská. Bohové nejsou podporovaný formát.</p><p class="text">Nad volbami se objevují náznaky dopadu: šipky, riziko a krátká věta, která se snaží být nápovědou, ne rodičem.</p><p class="text"><span class="fx-outline is-lit">Preview</span> ti říká, co se pravděpodobně změní: stat, riziko, někdy předmět, otisk nebo budoucí návrat karty. Neříká všechno. SYNTHOMA si nechává část škodolibosti pro sebe, jak už to rozhraní bez morálky dělávají.</p><p class="dialogS">„Nápověda není záruka. Je to cedule před jámou. Když do ní skočíš s mapou v ruce, systém bude mít aspoň lepší screenshot.“</p>`,
