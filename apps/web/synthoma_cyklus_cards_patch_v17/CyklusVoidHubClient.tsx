...
import { CyklusVoidHub, type CyklusVoidHubActionPayload, type CyklusVoidHubActions } from './CyklusVoidHub';
...
export function CyklusVoidHubClient({
  ...
  const syncFromServer = useCallback(async () => {
    ...
    if (server.progression && typeof server.progression === 'object') {
      saveSubjectProgression(server.progression as SubjectProgression);
    }
    return true;
  }, [preferServerSync]);
