...
export const CYKLUS_CARDS: Record<string, SwipeCard> = {
  ...
  tutorial_04_preview: {
    ...
    scene: 'Pod volbami vidíš náznak dopadu. Šipky ukazují, co se asi změní. Asi. T-AI tomu říká predikce. Sarkasma tomu říká „horoskop s lepším CSS".',
  ...
  tutorial_05_profile: {
    ...
    scene: 'Každá volba posune tvůj skrytý profil. Ne proto, aby tě systém zařadil do krabičky. Tedy dobře, trochu proto. Systémy milují krabičky. Je to jejich náhrada za duši.',
  ...
  tutorial_09_sectors: {
    ...
    scene: 'Prázdnota, Archiv, Pískoviště, Hnízdo Glitchky, Reziduum, Zrcadlo, Form Office, T-AI. Systém říká, že sektor ovlivňuje výběr karet. Sarkasma říká, že sektor je jen místnost, která se tváří, že má osobnost.',
    yesLabel: 'PROJÍT ARCHIVNÍ CHODBŮ',
  ...
  tutorial_10_cycle: {
    ...
    scene: 'Každý cyklus má dvanáct voleb. Pak přijde souhrn, otisk a mírný drift zpátky k centru. Systém tomu říká regulace. Sarkasma tomu říká: „uděláš dvanáct chyb, pak ti dáme pětiminutovou přestávku na sebemrzenčí."',
    yesLabel: 'POCHOPIT CYKLUS',
    noLabel: 'DĚLAT, ŽE TO BYLO JASNÉ',
    category: 'tutorial',
    rarity: 'unique',
    once: true,
    triggerMode: 'scheduledOnly',
  ...
  tutorial_14_packs: {
    ...
    scene: 'Packy jsou příběhové linky: Glitchka, Sarkasma, Černý box, Romance, ORGIE, Detektivka, Dvanáctník. Každá má svůj sektor, svou atmosféru a svůj způsob, jak tě naučit, že ses myslel, že víš, kdo jsi.',
