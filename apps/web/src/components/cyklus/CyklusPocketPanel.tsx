...
import type { SubjectProgression, PocketProgressionUiModel, CraftRecipeUiRow } from '../../game/cyklus/cyklusProgression';
import { getPocketProgressionUiModel } from '../../game/cyklus/cyklusProgression';
