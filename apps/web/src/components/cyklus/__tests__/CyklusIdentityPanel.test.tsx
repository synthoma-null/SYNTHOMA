...
jest.mock('../../../lib/LangContext', () => ({
  useLang: () => ({
    t: (key: string) => ({
      ...
      'shell.node': 'UZEL',
      'shell.library': 'KNIHOVNA',
      'shell.archive': 'ARCHIV',
      'shell.cyklus': 'CYKLUS',
      'shell.system': 'SYSTÉM',
      'shell.brand.aria': 'SYNTHOMA, hlavní uzel',
      'shell.active.aria': 'Aktivní sektor',
      'shell.sectors.aria': 'Hlavní sektory',
      'shell.controls.aria': 'Globální ovládání',
      'shell.identity': 'Identita',
      'shell.settings': 'Nastavení',
      'shell.audio.paused': 'Hudba: pozastaveno',
      'shell.mobile.aria': 'Mobilní sektory',
    }[key] ?? key),
  }),
}));
