(function(){
  ...
  function writeStorage(key, value, kind){
    var storage = getStorage(kind);
  ...
  function getStore(){
    ...
    let data = null;
    try { data = JSON.parse(readStorage(key, 'local')); } catch(e) { data = null; }
    if(!data){
      try { data = JSON.parse(readStorage(key, 'session')); } catch(e) { data = null; }
    }
  ...
  function saveStore(key, data){
    ...
    writeStorage(key, str, 'local');
    writeStorage(key, str, 'session');
  }
